...
$nViewFilter = GetHTTPParam('view', 'False');
...
//View Filters
$viewFilters = array('False' => 'Enabled Users', 'True' => 'Disabled Users');
//********End Parameters***********************************
...
if(($nViewFilter == 0) && ($szSearchString == '')){
	$aViewCondition['attributeName'] = 'isdisabled';
	$aViewCondition['operator'] = 'Equal';
	$aViewCondition['values'] = array($nViewFilter);
